...
for backbone in remoteclip-14 #openclip-14 georsclip-14 remoteclip-14 dinov2 openclip-14-remote-fmow
do
    for dataset in simd
    do
        for M in 2
        do
            for N in 30
            do
                echo "Creating prototypes for the ${dataset} dataset using ${backbone} features with N=${N}, M=${M}"
