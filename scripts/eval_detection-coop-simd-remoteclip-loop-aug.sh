...
finetune_type=boxes
COOP_NAME=simd_remoteclip_2-crop
        ...
        do
            ...
            do
                python -u eval_detection.py \
                    ...
                    --save_dir run/eval/detection/${dataset}/${prototype_type}/backbone_${backbone}_${finetune_type}/${COOP_NAME}/nctx${nctx}_cscFalse_ctp${ctp}/${conf}/N${N}-${M} \
